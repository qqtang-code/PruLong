...
def load_narrativeqa(dataset, shots=0, max_samples=None, seed=42):
    ...
    all_data = load_from_disk("/scratch/gpfs/ab4197/p-longhead/p-prulong/eval/HELMET-w-duoattn-eval/datasets/narrativeqa")
...
def load_multi_lexsum(dataset, path=None, shots=0, max_samples=None, seed=42):
    all_data = load_from_disk("/scratch/gpfs/ab4197/p-longhead/p-prulong/eval/HELMET-w-duoattn-eval/datasets/allenai-multi_lexsum")
...
def load_infbench(dataset, shots=0, max_test_samples=None, seed=42):
    ...
    data = load_from_disk("/scratch/gpfs/ab4197/p-longhead/p-prulong/eval/HELMET-w-duoattn-eval/datasets/xinrongzhang2022-infinitebench")
