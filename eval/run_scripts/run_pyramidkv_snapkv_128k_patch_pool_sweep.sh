...
# Configuration
# ============================================================================
SCRIPT_NAME="pyramidkv_snapkv_128k_patch_pool_sweep"
DEFAULT_NUM_GPUS=1
...
OUT_DIR=outputs/${MODEL_NAME}/PATCH_POOL${POOL_SIZE}_outputs${SUFFIX}__${METHOD}
...
for TASK in ${COMMON_TASKS[@]}; do 
    for METHOD in pyramidkv snapkv; do
        for POOL_SIZE in 1024 2048 4096 8192 16384 32768; do
            ...
            EXTRA="--no_torch_compile --minference_sparsity $SPARSITY_FRAC --minference_window_size $MINFERENCE_WINDOW_SIZE --minference_chunk_prefilling $TOTAL_CAPACITY --minference_max_capacity_prompt $POOL_SIZE --minference_chunking_patch"
